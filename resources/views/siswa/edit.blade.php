...
@section('content')
    <div class="page-inner mt--3">
        <form action="{{ route('siswa.update', ['siswa' => $siswa->nisn_15483]) }}" method="post">
            @method('put')
            @csrf
            {{-- <input type="hidden" name="old_password_15483" value="{{ $siswa->password_15483 }}">
            <input type="hidden" name="old_username_15483" value="{{ $siswa->nis_15483 }}"> --}}

            <div class="form-group">
                <label for="nisn_15483">Nisn</label>
                <input type="text" class="form-control @error('nisn_15483') is-invalid @enderror" id="nisn_15483"
                    name="nisn_15483" placeholder="Masukan Nisn"
                    value="{{ old('nisn_15483', $siswa->nisn_15483) }}" required autofocus>
                @error('nisn_15483')
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nis_15483') is-invalid @enderror" id="nis_15483"
                    name="nis_15483" placeholder="Masukan Nis"
                    value="{{ old('nis_15483', $siswa->nis_15483) }}" required>
                @error('nis_15483')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_15483') is-invalid @enderror" id="nama_15483"
                    name="nama_15483" placeholder="Masukan Nama"
                    value="{{ old('nama_15483', $siswa->nama_15483) }}" required>
                @error('nama_15483')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('alamat_15483') is-invalid @enderror" id="alamat_15483"
                    name="alamat_15483" placeholder="Masukan alamat"
                    value="{{ old('alamat_15483', $siswa->alamat_15483) }}" required>
                @error('alamat_15483')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
            ...
            <div class="form-group">
                <label for="no_telp_15483">No Telepon</label>
                <input type="number" class="form-control @error('no_telp_15483') is-invalid @enderror" id="no_telp_15483"
                    name="no_telp_15483" placeholder="Masukan No Telepon"
                    value="{{ old('no_telp_15483', $siswa->no_telp_15483) }}" required>
                @error('no_telp_15483')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
