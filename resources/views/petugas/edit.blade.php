...
@section('content')
    <div class="page-inner mt--3">
        <form action="{{ route('petugas.update', ['petuga' => $petugas->id_petugas_15483]) }}" method="post">
            @method('put')
            @csrf
            <input type="hidden" name="old_password_15483" value="{{ $petugas->password_15483 }}">
            <input type="hidden" name="old_username_15483" value="{{ $petugas->username_15483 }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('username_15483') is-invalid @enderror" id="username_15483"
                    name="username_15483" placeholder="Masukan Username"
                    value="{{ old('username_15483', $petugas->username_15483) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_petugas_15483') is-invalid @enderror" id="nama_petugas_15483"
                    name="nama_petugas_15483" placeholder="Masukan Nama Lengkap"
                    value="{{ old('nama_petugas_15483', $petugas->nama_petugas_15483) }}" required autofocus>
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('level_15483') is-invalid @enderror" id="level_15483"
                    name="level_15483" placeholder="Masukan Nama Lengkap"
                    value="{{ old('level_15483', $petugas->level_15483) }}" required autofocus>
